...
## To Do
- [ ] **[SaaS Product Hub] CEO ตัดสิน §10 decisions ของ master plan revision 3 (CEO)** - 🔴 **BLOCKER** — §10.9 billing-core Supabase placement (block P1 + PS01/LK01/DC01 ทั้งสามตัว), §10.2 hostname convention `booking.wstera.com` vs `bk01.wstera.com` (block DNS record แรก), §10.3 Hub per-product event signing key. รวม 9 ข้อ ดู `docs/platform/PORTFOLIO_PRODUCTION_MASTER_PLAN.md` §10. Review record: `vault/06-Agent-Logs/SaaS-Product-Hub/2026-08-27-commander-final-review.md`
