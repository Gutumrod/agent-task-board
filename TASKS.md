...
## To Do
- [ ] **[SaaS Product Hub] CEO ตัดสิน §10 decisions ที่เหลือ (CEO)** - 🟡 **D1 hostname / D2 event trust / D3 billing-core DB ตัดสินแล้ว 2026-08-27** (code host / per-product HMAC / dedicated schema ใน Project A + 5 เงื่อนไข — ดู master plan §10 Decided). **ยังค้าง:** repo path casing, D4 PawSpace billing trust, PawSpace brand, CM01 boundary, HC01 boundary, operational SLO/RTO/RPO. ดู `docs/platform/PORTFOLIO_PRODUCTION_MASTER_PLAN.md` §10 Still-open
