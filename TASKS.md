...
## To Do
- [ ] **[SaaS Product Hub] CEO §10 decisions — 2 ข้อสุดท้าย (CEO)** - 🟡 **D1–D7 ตัดสินแล้ว 2026-08-27** (hostname=code host / event trust=per-product HMAC / billing DB=schema ใน Project A / PawSpace ingress=narrow / casing=lowercase / CM01=template only / SLO 99% RTO 4h RPO 24h, billing RPO ≤1h). **ยังค้าง 2 ข้อ:** (1) PawSpace ชื่อใหม่ — เช็คแล้วชนจริง ใช้ชื่อเดิมภายในไปก่อน ห้าม customer-facing (2) HC01 scope — CEO จะเพิ่มเอกสาร ยังไม่เริ่ม DB/API. ดู `docs/platform/PORTFOLIO_PRODUCTION_MASTER_PLAN.md` §10
